...
<body>
    ...
    <div class="container-fluid">
        <ul class="list-group list-group-flush">
            ...
            <li class="list-group-item"><b>Hướng dẫn viên: </b> <?= $tourguiderName ?></li>
            <li class="list-group-item"><b>Số chỗ: </b> <?= $tour["seats"] ?></li>
            ...
            <li class="list-group-item"><b>Gía / 1 người: </b> <?= $tour["price"] ?></li>
